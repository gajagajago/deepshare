...
- L1575-1595 DeepShare profiler (PyTorch profiler, CPU profiler) added
- L1625-1632 DeepShare profiler stop condition
...
sys.path.append(os.path.join(os.environ['DEEPSHARE_PATH'], 'models/DLRM'))
...
# DeepShare: Added argument `slurm_handler` to `run()`
def run(slurm_handler: DeepShareSlurmHandler):
    ...
    if not args.debug_mode:
        ...
        # DeepShare: Each process is given rank = `SLURM_PROCID`
...
# DeepShare: install handler/profiler, launch main code with arguments
if __name__ == "__main__":
    args = _parse_args()
    slurm_handler = DeepShareSlurmHandler(DummyDeepShareJobCheckpointer()) # TODO: add DLRM checkpointer
